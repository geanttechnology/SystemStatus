      ...
      <?php Theme::loadView('admin/layout'); ?>
        ...
        <div class="list-group hidden-sm hidden-xs">
            ...
            <?php if(SecurityController::checkAccess(3)): ?>
              ...
              <button type="button" class="list-group-item" onclick="document.location.href='<?=APP_URL?>/admin/themes'">Thèmes<i class="fa fa-paint-brush pull-right nav-icon"></i></button>
