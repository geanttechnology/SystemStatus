    ...
    return [
        ...
        "admin" => [
            ...
            "themes" => [
                ...
                "list-themes-installed" => "Liste des themes installés",

                "maj-name" => "Nom",
                "maj-author" => "Autheur",
                "maj-version" => "Version",
                "maj-compatible" => "Compatible",
                "maj-status" => "Statut",
                "maj-action" => "Action",
                ...
                "maj-edit" => "Editer",
                "theme-default-dont-deactivate" => "Le theme par défaut ne peut être désactivé",
                "maj-deactivate" => "Désactiver",
                "maj-activate" => "Activer",
                "theme-default-dont-delete" => "Le theme par défaut ne peut être supprimé",
                "maj-delete" => "Supprimer",
            ...
            "users" => [
                ...
                "maj-user" => "Utilisateur",
                "kind-account" => "Type de compte",
                "add-user" => "Ajouter un utilisateur",
                "maj-normal" => "Normal",
                "maj-admin" => "Administrateur",
                "maj-validate" => "Valider",
